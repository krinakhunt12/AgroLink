...
export const FinalCTA: React.FC<FinalCTAProps> = React.memo(({
    ...
    return (
        <section className="py-32 bg-brand-primary text-center text-white relative overflow-hidden">
            {/* Decorative Elements */}
            ...
            <div className="max-w-4xl mx-auto px-6 relative z-10">
                <h2 className="text-4xl md:text-6xl font-semibold mb-10 leading-[1.05] tracking-tighter uppercase">{title}</h2>
                <p className="text-xl md:text-2xl text-white/80 mb-14 max-w-2xl mx-auto font-medium leading-relaxed">{subtitle}</p>
                <Button asChild size="lg" className="rounded-sm text-xl h-auto py-4 px-14 bg-white text-brand-primary hover:-translate-y-2 transition-all font-semibold uppercase tracking-widest border-none">
                    <Link to="/register">
                        {buttonText}
                    </Link>
                </Button>
